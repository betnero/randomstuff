...
for ping in range(1, 256): # IP range
 ...
 - add argparse to introduce flags for each feature (i.e. user to specify the IP (first 3 octets), full scan of all hosts within a network, 
 sleep for a specific time between each IP scan, specify upper and lower IP range)
 '''
